...
describe('Async actions: userData', () => {
  ...
  it('should authorization status is "AUTH" and load userProcess when server return 200', async () => {
    mockAPI
  ...
  it('should save token and load userProcess when POST /login', async () => {
